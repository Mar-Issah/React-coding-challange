...
const fetchPhotos = async ({ pageParam = 1 }: { pageParam: any }) => {
  return await axios.get(
    `https://api.unsplash.com/photos/?page=${9}&per_page=12&client_id=q-BdrEabVEk28udJqFm30HN_AA_xbs_KnE53hsE2lgc`
  );
};
